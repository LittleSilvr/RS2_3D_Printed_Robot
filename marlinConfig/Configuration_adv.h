...
#define HOMING_BUMP_MM      { 5, 5, 2 ,1 ,1}       // (linear=mm, rotational=°) Backoff from endstops after first bump
 ...
 */
  ...
  #define I_HYBRID_THRESHOLD     100  // [linear=mm/s, rotational=°/s]
  #define J_HYBRID_THRESHOLD     100  // [linear=mm/s, rotational=°/s]
